...
class StockScanner:
    ...
    def setup_telegram(self):
        ...
        try:
            self.bot = telegram.Bot(token='YOUR_BOT_TOKEN')  # Replace with your bot token
            self.chat_id = 'YOUR_CHAT_ID'  # Replace with your group chat ID
            # Test the connection
            asyncio.run(self.send_telegram_alert("🔄 Scanner started and connected to Telegram"))
    ...
    def send_pattern_alert(self, symbol, pattern, data):
        """Format and send pattern detection alert"""
        message = f"""🎯 <b>Pattern Detected!</b>
