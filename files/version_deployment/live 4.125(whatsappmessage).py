...
class StockScanner:
    def __init__(self):
        ...
        #whatsapp
        self.WHATSAPP_GROUP = "Trade_alts"  # Default group name
    ...
    def send_test_message(self):
        """New method to test WhatsApp messaging"""
        if not self.whatsapp_enabled.get():
            messagebox.showinfo("WhatsApp", "Please enable WhatsApp notifications first")
            return
            
        threading.Thread(target=self._send_test_message_thread, daemon=True).start()
    ...
    def add_whatsapp_pattern(self):
        """Add this method to handle adding patterns for WhatsApp notifications"""
    ...
    def update_whatsapp_patterns_label(self):
        """Add this method to update the display of selected patterns"""
