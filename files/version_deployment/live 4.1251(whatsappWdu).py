...
class StockScanner:
    def __init__(self):
        ...
        #whatsapp
        self.WHATSAPP_GROUP = "Trade-alerts"  # Default group name
    ...
    def send_test_message(self):
        ...
        try:
            ...
            test_thread.start()
            messagebox.showinfo("WhatsApp", "Sending test message...")
    ...
    def send_whatsapp_message(self, message):
        """New method to handle WhatsApp message sending"""
        try:
            ...
            logger.info(f"WhatsApp message queued for group {self.WHATSAPP_GROUP}")
        except Exception as e:
